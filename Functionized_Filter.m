...
%Lowpass
y = gain(1) .* lowpass(fs,input,lp_fc,dt);
%Bandpass
y = y + (gain(2) .* bandpass(fs,input,bp1_fc1,bp1_fc2,5,dt));
%Bandpass
y = y + (gain(3) .* bandpass(fs,input,bp2_fc1,bp2_fc2,5,dt));
%Bandpass
y = y + (gain(4) .* bandpass(fs,input,bp3_fc1,bp3_fc2,5,dt));
%Highpass
y = y + (gain(5) .* highpass(fs,input,hp_fc,dt));
